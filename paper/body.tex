...
The difference-in-means estimator is the MLE only when the other externalities are
known; it is invoked here solely as a \emph{lower bound} on the harder joint
