...
to estimate it, and act on ECI --- holds where destruction is independent across
arms and requires a not-yet-found correction where it is correlated. Practitioners
in the domains motivating this paper should check which regime applies before
deploying ECI as-is.
\end{corollary}
